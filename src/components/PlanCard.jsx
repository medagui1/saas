...
const PlanCard = ({ plan, planInterval, middle, data_aos }) => {
  ...
  return (
    <div
      ...
      data-aos={data_aos}
    >
      <h5 className="font-bold text-2xl mb-2"> {plan.name} </h5>
      ...
      <h6 className="font-bold uppercase text-start text-sm mb-2">
        What's included:{" "}
      </h6>
      ...
      <h6 className="font-bold uppercase text-start text-sm mb-2 mt-32 max-sm:mt-8">
        Design team{" "}
      </h6>
